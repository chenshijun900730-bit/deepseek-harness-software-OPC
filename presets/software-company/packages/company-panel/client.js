...
(function () {
  ...
  headerBtns.appendChild(presetW('窄', 480)); headerBtns.appendChild(presetW('中', 640)); headerBtns.appendChild(presetW('宽', 900))
  ...
  canvasBtn.addEventListener('click', function () {
    ...
    if (canvasOpen && panelSize.w < 900) { panelSize.w = 900; applySize() }
    render()
  })
